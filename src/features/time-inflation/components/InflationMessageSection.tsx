  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1100px] min-h-[min(85vh,860px)] flex flex-col">
        <h2 className="m-0 text-[clamp(2.6rem,5.4vw,4.2rem)] leading-[1.05] font-semibold text-text-default-default max-w-[860px]">
        ...
        <p className="mt-16 max-w-[860px] text-[15px] leading-[1.45] text-text-default-secondary">
        ...
        <div className="flex-1 flex items-end justify-center">
          <p className="m-0 mb-6 text-center text-[clamp(2.3rem,4.8vw,3.6rem)] leading-[1.1] font-semibold text-text-default-default max-w-[920px]">
            You work more hours,
            <br />
