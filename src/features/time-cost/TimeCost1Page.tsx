            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <CardContent className="pt-0">
                  <div className="max-h-[min(60vh,400px)] overflow-y-auto pr-2 space-y-4 text-[var(--color-text)]">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 py-2">
                      ...
                      <span>{submitted.leisureHoursPerDay || "Not provided"}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="rounded-xl border-2 border-neutral-200 bg-white shadow-lg overflow-hidden">
                ...
                <CardContent className="pt-4">
                  <DayDistributionPie
                    workHours={parsePositiveNumber(submitted.workHoursPerDay) ?? 0}
                    sleepHours={8}
                    leisureHours={Math.max(
                      24 - ((parsePositiveNumber(submitted.workHoursPerDay) ?? 0) + 8),
                      0
                    )}
                  />
                </CardContent>
            ...
            <div className="mb-10 text-center">
              {parsePositiveNumber(submitted.workHoursPerDay) && (
                <p className="text-[clamp(1.5rem,3vw,2rem)] font-semibold text-text-default-default">
                  {`Let\u2019s focus on that ${((parsePositiveNumber(submitted.workHoursPerDay) ?? 0) / 24 * 100).toFixed(1)}%`}
                </p>
              )}
            </div>
