    ...
    <Card className="rounded-xl border-2 border-border-default-default bg-background-default-default shadow-lg overflow-hidden">
      ...
      <CardContent className="pt-0">
        <div className="max-h-[min(60vh,400px)] overflow-y-auto pr-2 space-y-4 text-[var(--color-text)]">
          <div className="flex flex-wrap gap-x-4 gap-y-1 py-2 border-b border-border-default-default/50">
            <span className="text-text-default-secondary font-medium min-w-[140px]">Country</span>
            <span>{countryName || "Not provided"}</span>
          </div>
          <div className="flex flex-wrap gap-x-4 gap-y-1 py-2 border-b border-border-default-default/50">
            <span className="text-text-default-secondary font-medium min-w-[140px]">Age</span>
            <span>{age || "Not provided"}</span>
          </div>
          <div className="flex flex-wrap gap-x-4 gap-y-1 py-2 border-b border-border-default-default/50">
            <span className="text-text-default-secondary font-medium min-w-[140px]">Monthly Income (Gross)</span>
            <span>{monthlyIncome || "Not provided"}</span>
          </div>
          <div className="flex flex-wrap gap-x-4 gap-y-1 py-2 border-b border-border-default-default/50">
            <span className="text-text-default-secondary font-medium min-w-[140px]">Hours you work per day</span>
            <span>{workHoursPerDay || "Not provided"}</span>
          </div>
          <div className="flex flex-wrap gap-x-4 gap-y-1 py-2 border-b border-border-default-default/50">
            <span className="text-text-default-secondary font-medium min-w-[140px]">Hours you sleep per day</span>
            <span>{sleepHoursPerDay || "Not provided"}</span>
          </div>
          <div className="flex flex-wrap gap-x-4 gap-y-1 py-2">
            <span className="text-text-default-secondary font-medium min-w-[140px]">Hours of leisure per day</span>
