  ...
  return (
    <div className="w-full min-h-screen bg-background-default-default">
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 py-12">
        <h1 className="text-[clamp(2.5rem,6vw,4rem)] font-bold tracking-tight text-text-default-default mb-8">
          About
        </h1>
        <div className="space-y-6 text-text-default-secondary text-[18px] leading-[1.65]">
          <p>
          ...
          <blockquote className="border-r-4 border-border-default-default pr-6 py-2 my-8 italic text-right text-[20px] leading-[1.5]">
            <p>
              &quot;Enlightenment is humanity&apos;s emergence from its self-imposed immaturity.&quot;
            </p>
            <footer className="mt-2 not-italic text-[18px] text-text-default-secondary">
              — Immanuel Kant
            </footer>
          </blockquote>
        </div>
